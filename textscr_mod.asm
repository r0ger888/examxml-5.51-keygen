...
ScrollFont		LOGFONT <8,8,0,0,FW_DONTCARE,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,0,'verdana'>

ScrollText	    		db	"ExamXML 5.51 *kEyGeN By MaryNello* :: "
						db  "sPecial gr33tZ 2 all my friendz out there incl GRUiA, WeeGee, r0ger, "
						db  "DAViD, Al0hA, B@TRyNU, ShTEFY, s0r3l, sabYn, ShoGun, zzLaTaNN, yMRAN and"
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,0
		mov scr.scroll_y,237
		
		mov scr.scroll_width,303
